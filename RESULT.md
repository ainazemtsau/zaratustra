...
Реализован вложенный составной Work с точным Method роли, выдачей по цепочке
предков, собственным принятием, явным атомарным закрытием потомков при замене
и обслуживанием адресной истории. Пакет предназначен для одного технического
review; приёмка не записана.
