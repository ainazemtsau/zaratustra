...
Код и регрессии зафиксированы чистым коммитом
`cb569fce96091d716fa1753f1f4d7f401473e41a` ветки
...
Все эти проверки — собственные проверки данного пакета. Независимое
review этого пакета ещё не выполнено.
...
начинается. Пакет передаётся на одно общее независимое review.
